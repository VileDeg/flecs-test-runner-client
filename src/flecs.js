      ...
      return {
        ...
        set: function(path, component, value, recv, err, ) {
          ...
          return this._.request(this, "PUT", "component/" + path, 
            {component: component, value: value}, recv, err);
        },
        ...
        requestPub: function(method, path, params, recv, err, on_abort, poll_interval_ms) {
          return this._.request(this, method, path, params, 
            recv, err,
            on_abort,
            poll_interval_ms);
        },
