...
Will connect to a locally running Flecs application on default Flecs Rest API port (see the Flecs docs).
...
TODO: the project accessible on <insert_link>, deployed on e.g. GitHub pages.
